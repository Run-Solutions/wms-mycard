...
export default function HotStampingComponent({ workOrder }: Props) {
  ...
  console.log('hola',antepenultima);
      ...
      <NewData>
        ...
        <NewDataWrapper>
          <Table>
            ...
            <tr>
              <td>Buenas</td>
              <td>{antepenultima?.corteResponse?.good_quantity ?? ''}</td>
              <td>{penultima?.colorEdgeResponse?.good_quantity ?? ''}</td>
              <td>{ultima?.hotStampingResponse?.good_quantity ?? ''}</td>
            ...
            <tr>
              <td>Malas</td>
              <td>{antepenultima?.corteResponse?.bad_quantity ?? ''}</td>
              <td>{penultima?.colorEdgeResponse?.bad_quantity ?? ''}</td>
              <td>{ultima?.hotStampingResponse?.bad_quantity ?? ''}</td>
              <td>{workOrder.answers[0].millingChipResponse?.bad_quantity ?? ''}</td>
              <td>{workOrder.answers[0].personalizacionResponse?.bad_quantity ?? ''}</td>
            </tr>
            <tr>
              <td>Excedente</td>
              <td>{antepenultima?.corteResponse?.excess_quantity ?? ''}</td>
              <td>{penultima?.colorEdgeResponse?.excess_quantity ?? ''}</td>
              <td>{ultima?.hotStampingResponse?.excess_quantity ?? ''}</td>
            ...
            <tr>
              <td>SUMA TOTAL</td>
              <td>{((antepenultima?.corteResponse?.good_quantity ?? '') + (antepenultima?.corteResponse?.bad_quantity ?? '') + (antepenultima?.corteResponse?.excess_quantity ?? '') + (antepenultima?.sample_quantity ?? ''))}</td>
              <td>{((penultima?.colorEdgeResponse?.good_quantity ?? '') + (penultima?.colorEdgeResponse?.bad_quantity ?? '') + (penultima?.colorEdgeResponse?.excess_quantity ?? '') + (penultima?.sample_quantity ?? ''))}</td>
              <td>{((ultima?.hotStampingResponse?.good_quantity ?? '') + (ultima?.hotStampingResponse?.bad_quantity ?? '') + (ultima?.hotStampingResponse?.excess_quantity ?? '') + (ultima?.sample_quantity ?? ''))}</td>
              <td>{workOrder.answers[0].millingChipResponse?.form_answer?.sample_quantity ?? ''}</td>
              <td>{workOrder.answers[0].personalizacionResponse?.form_answer?.sample_quantity ?? ''}</td>
            </tr>
          </tbody>
