...
export default function ImpresionComponent({ formQuestion }: Props) {
    ...
    <Container>
      ...
      <NewData>
        ...
        <Table>
          ...
          <tbody>
            {formQuestions.filter((question: any) => question.role_id === null && question.areas.some((area: any) => area.id === 2))
              .map((question: any) => {
        ...
        <InputGroup>
          ...
          <Table>
            ...
            <tbody>
            {formQuestions.filter((question: any) => question.role_id === 3 && question.areas.some((area: any) => area.id === 2))
              .map((question: any) => {
                // Como no mostraste la estructura de las respuestas aquí, lo dejo vacío
                const frontAnswer = null; 
                const vueltaAnswer = null;
