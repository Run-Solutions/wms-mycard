...
// Nuevo componente para el título
...
// Nuevo componente para el mensaje de bienvenida o subtítulo
...
const LoginForm: React.FC<LoginFormProps> = ({
  ...
  return (
    <Form onSubmit={onSubmit}>
      {/* Agregamos el título y el mensaje de bienvenida */}
      <Title>Welcome!!</Title>
      ...
      <FlexRow>
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          <label htmlFor="remember" style={{ fontSize: "14px", color: "black", fontWeight: "400" }}>
            Remember me
          </label>
        </div>
      ...
      <FlexRow>
        <Btn>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20">
            ...
            ></path>
            <path
              d="M419.404,58.936l-82.933,67.896c-23.335-14.586-50.919-23.012-80.471-23.012 c-66.729,0-123.429,42.957-143.965,102.724l-83.397-68.276h-0.014C71.23,56.123,157.06,0,256,0 c161.115,0,218.068,22.126,262.404,58.936Z"
              style={{ fill: "#F14336" }}
            ></path>
          </svg>
          Google
