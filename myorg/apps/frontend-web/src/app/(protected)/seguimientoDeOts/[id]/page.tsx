          ...
          <TableWrapper>
            <Table>
              ...
              <tbody>
                ...
                <tr>
                  <td>Auditor</td>
                  {areas.map((area) => <td key={area.id}>{area.auditor}</td>)}
                </tr>
                <tr>
                  <td>Estado</td>
                  {areas.map((area) => <td key={area.id}>{area.status}</td>)}
                </tr>
                <tr>
                  <td>Buenas</td>
                  {areas.map((area) => <td key={area.id}>{area.buenas}</td>)}
                </tr>
                <tr>
                  <td>Malas</td>
                  {areas.map((area) => <td key={area.id}>{area.malas}</td>)}
                </tr>
                <tr>
                  <td>Excedente</td>
                  {areas.map((area) => <td key={area.id}>{area.excedente}</td>)}
                </tr>
                <tr>
                  <td>CQM</td>
                  {areas.map((area) => <td key={area.id}>{area.cqm}</td>)}
                </tr>
                <tr>
                  <td>Muestras</td>
                  {areas.map((area) => <td key={area.id}>{area.muestras}</td>)}
                </tr>
                <tr>
                  <td>SUMA TOTAL</td>
                  {areas.map((area) => <td key={area.id}>{area.buenas + area.malas + area.excedente + area.cqm + area.muestras}</td>)}
                </tr>
              </tbody>
            </Table>
          </TableWrapper>
          {workOrder?.status !== 'Cerrado' && <CloseButton onClick={() => setShowConfirm(true)}>Cerrar Orden de Trabajo</CloseButton>}
        </Section>
      </Container>
