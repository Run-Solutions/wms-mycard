      ...
      <CardsContainer>
        {users.map((user) => (
          <UserCard key={user.id}>
            ...
            <CardActions>
              <ActionButton onClick={() => handleEdit(user)}>Editar</ActionButton>
              <ActionButton onClick={() => handleDelete(user)}>Eliminar</ActionButton>
            </CardActions>
          </UserCard>
        ))}
      </CardsContainer>
...
const Title = styled.h1<{ theme: any }>`
  ...
  -webkit-text-stroke: 2px ${props => props.theme.palette.secondary.dark};
`;
