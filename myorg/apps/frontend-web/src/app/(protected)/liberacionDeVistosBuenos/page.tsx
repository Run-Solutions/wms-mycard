// myorg/apps/frontend-web/src/app/(protected)/liberacionDeVistosBuenos/page.tsx
'use client';

import React, { useEffect, useState } from 'react';
import styled, { useTheme } from 'styled-components';
import WorkOrderTable from '@/components/liberacionDeVistosBuenos/WorkOrderTable';
