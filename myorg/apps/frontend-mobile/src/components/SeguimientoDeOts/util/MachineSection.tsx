      ...
      <ScrollView horizontal>
        <View style={styles.table}>
          ...
          <View style={[styles.row, styles.header]}>
            <Text style={[styles.cell, styles.headerText, { flex: 2, minWidth: 500 }]}>
              Pregunta
            </Text>
            <Text style={[styles.cell, styles.headerText, { flex: 1, textAlign: 'center' }]}>
              Respuesta
            </Text>
          </View>
          ...
          {filteredQuestions.map((q) => {
            ...
            return (
              <View key={q.id} style={styles.row}>
                <Text style={[styles.cell, { flex: 1, minWidth: 500 }]}>{q.title}</Text>
