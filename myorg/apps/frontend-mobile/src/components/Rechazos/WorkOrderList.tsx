// myorg/apps/frontend-mobile/src/components/Rechazos/WorkOrderList.tsx
"use client";
...
type Navigation = NavigationProp<InternalStackParamList, 'RechazosAuxScreen'>;
import {
  View,
  Text,
  FlatList,
