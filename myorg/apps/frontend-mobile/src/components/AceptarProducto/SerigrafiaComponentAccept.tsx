// src/components/AceptarProducto/SerigrafiaComponentAccept.tsx
...
const SerigrafiaComponentAccept: React.FC<{ workOrder: any }> = ({ workOrder }) => {
...
export default SerigrafiaComponentAccept;
