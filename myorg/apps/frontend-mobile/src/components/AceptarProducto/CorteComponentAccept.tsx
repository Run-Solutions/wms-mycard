...
const CorteComponentAccept: React.FC<{ workOrder: any }> = ({ workOrder }) => {
  const navigation =
  ...
  useEffect(() => {
    const areaKey = areaKeyById[6];
    const vals = computeAreaDefaults<CorteData>(
      areaKey,
...
export default CorteComponentAccept;
