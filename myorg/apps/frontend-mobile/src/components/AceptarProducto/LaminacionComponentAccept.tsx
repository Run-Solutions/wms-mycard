// src/components/AceptarProducto/LaminacionComponentAccept.tsx
...
const LaminacionComponentAccept: React.FC<{ workOrder: any }> = ({ workOrder }) => {
...
export default LaminacionComponentAccept;
