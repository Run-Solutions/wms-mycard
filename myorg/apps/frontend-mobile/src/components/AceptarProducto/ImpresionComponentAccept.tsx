// src/components/AceptarProducto/ImpresionComponentAccept.tsx
...
const ImpresionComponentAccept: React.FC<{ workOrder: any }> = ({
  workOrder,
}) => {
  const navigation =
  ...
  useEffect(() => {
    ...
    if (impresion && partials.length === 0) {
      ...
      const restante = (impresion.release_quantity || 0) - totalParciales;
...
export default ImpresionComponentAccept;
