...
import { acceptMillingChipInconformity } from '../../api/inconformidades';
...
const MillingChipComponent: React.FC<{ workOrder: any }> = ({ workOrder }) => {
  const navigation =
