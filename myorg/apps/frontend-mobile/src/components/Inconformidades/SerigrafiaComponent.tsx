...
import { acceptSerigrafiaInconformity } from '../../api/inconformidades';
...
const SerigrafiaComponent: React.FC<{ workOrder: any }> = ({ workOrder }) => {
  ...
  const releaseQuantity = lastPartialRelease
    ...
    : workOrder.areaResponse?.serigrafia.release_quantity;
