// myorg/apps/frontend-mobile/src/components/AceptarAuditoria/MillingChipComponent.tsx
...
import {
  acceptWorkOrderFlowMillingChipAuditory,
...
const MillingChipComponentAcceptAuditory: React.FC<{ workOrder: any }> = ({
  ...
  const handleAceptar = async () => {
    ...
    try {
      await acceptWorkOrderFlowMillingChipAuditory(
        MillingChipId,
        sampleAuditory
      );
