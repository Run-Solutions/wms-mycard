...
export const submitToCQMEmpalme = async (payload: CQMPayload): Promise<void> => {
  try {
    await API.post('/free-order-flow/cqm-empalme', payload);
  } catch (error: any) {
    console.error('Error en submitToCQMEmpalme:', error?.response?.data || error.message);
    throw new Error('No se pudo enviar el formulario a CQM.');
  }
};
export const submitToCQMLaminacion = async (payload: CQMPayload): Promise<void> => {
  try {
    await API.post('/free-order-flow/cqm-laminacion', payload);
  } catch (error: any) {
    console.error('Error en submitToCQMLaminacion:', error?.response?.data || error.message);
    throw new Error('No se pudo enviar el formulario a CQM.');
  }
};
export const submitToCQMCorte = async (payload: CQMPayload): Promise<void> => {
  try {
    ...
    console.error('Error en submitToCQMCorte:', error?.response?.data || error.message);
    throw new Error('No se pudo enviar el formulario a CQM.');
  }
};
export const submitToCQMColorEdge = async (payload: CQMPayload): Promise<void> => {
  try {
    await API.post('/free-order-flow/cqm-color-edge', payload);
  } catch (error: any) {
    console.error('Error en submitToCQMColorEdge:', error?.response?.data || error.message);
    throw new Error('No se pudo enviar el formulario a CQM.');
  }
};
export const submitToCQMHotStamping = async (payload: CQMPayload): Promise<void> => {
  try {
    await API.post('/free-order-flow/cqm-hot-stamping', payload);
  } catch (error: any) {
    console.error('Error en submitToCQMHotStamping:', error?.response?.data || error.message);
    throw new Error('No se pudo enviar el formulario a CQM.');
  }
};
export const submitToCQMMillingChip = async (payload: CQMPayload): Promise<void> => {
  try {
...
export const submitToCQMPersonalizacion = async (payload: CQMPayload): Promise<void> => {
  try {
    await API.post('/free-order-flow/cqm-personalizacion', payload);
  } catch (error: any) {
    console.error('Error en submitToCQMPersonalizacion:', error?.response?.data || error.message);
    throw new Error('No se pudo enviar el formulario a CQM.');
  }
};
...
export const releaseProductFromEmpalme = async (payload: ReleasePayload): Promise<void> => {
  try {
    await API.post('/free-order-flow/empalme', payload);
  } catch (error: any) {
    console.error('Error en releaseProductFromEmpalme', error?.response?.data || error.message);
    throw new Error('No se pudo liberar el producto desde Empalme.');
  }
};
export const releaseProductFromLaminacion = async (payload: ReleasePayload): Promise<void> => {
  try {
    await API.post('/free-order-flow/laminacion', payload);
  } catch (error: any) {
    console.error('Error en releaseProductFromLaminacion', error?.response?.data || error.message);
    throw new Error('No se pudo liberar el producto desde Laminacion.');
  }
};
export const releaseProductFromCorte = async (payload: ReleasePayloadForAuditory): Promise<void> => {
  try {
    await API.post('/free-order-flow/corte', payload);
  } catch (error: any) {
    console.error('Error en releaseProductFromCorte', error?.response?.data || error.message);
    throw new Error('No se pudo liberar el producto desde Corte.');
  }
};
export const releaseProductFromColorEdge = async (payload: ReleasePayloadForAuditory): Promise<void> => {
  try {
    await API.post('/free-order-flow/color-edge', payload);
  } catch (error: any) {
    console.error('Error en releaseProductFromColorEdge', error?.response?.data || error.message);
    throw new Error('No se pudo liberar el producto desde Color Edge.');
  }
};
export const releaseProductFromHotStamping = async (payload: ReleasePayloadForAuditory): Promise<void> => {
  try {
...
export const releaseProductFromMillingChip = async (payload: ReleasePayloadForAuditory): Promise<void> => {
  try {
    await API.post('/free-order-flow/milling-chip', payload);
  } catch (error: any) {
    console.error('Error en releaseProductFromMillingChip', error?.response?.data || error.message);
    throw new Error('No se pudo liberar el producto desde Milling Chip.');
  }
};
export const releaseProductFromPersonalizacion = async (payload: ReleasePayloadForAuditory): Promise<void> => {
  try {
    await API.post('/free-order-flow/personalizacion', payload);
  } catch (error: any) {
    console.error('Error en releaseProductFromPersonalizacion', error?.response?.data || error.message);
